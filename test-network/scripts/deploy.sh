...
peer lifecycle chaincode approveformyorg -o orderer.example.com:7050 --tls --cafile $ORDERER_CA --channelID mychannel --name basic --version 1 --package-id $PACKAGE_ID --sequence 1 --init-required --signature-policy "OR ('PetaniMSP.peer','PengepulMSP.peer','DistributorMSP.peer','RetailerMSP.peer')" 
...
sleep 5
peer lifecycle chaincode commit -o orderer.example.com:7050 --tls --cafile $ORDERER_CA --channelID mychannel --name basic $PEER_CONN_PARMS --version 1 --sequence 1 --init-required --signature-policy "OR ('PetaniMSP.peer','PengepulMSP.peer','DistributorMSP.peer','RetailerMSP.peer')" 
