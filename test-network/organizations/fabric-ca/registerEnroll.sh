...
function createOrderer() {
  ...
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:10054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/coedinus.com/orderers/orderer5.ecoedinus.com/tls --enrollment.profile tls --csr.hosts orderer5.coedinus.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  { set +x; } 2>/dev/null
