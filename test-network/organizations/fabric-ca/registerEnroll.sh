...
function creatCoe2() {
  ...
  cp ${PWD}/organizations/peerOrganizations/coe2.dinus.com/msp/config.yaml ${PWD}/organizations/peerOrganizations/coe2.dinus.com/users/Admin@ocoe2.dinus.com/msp/config.yaml
