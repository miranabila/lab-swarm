...
function createPetani() {
  ...
  mkdir -p organizations/peerOrganizations/petani.coedinus.com/peers/peer0.petani.coedinuse.com
  ...
  cp ${PWD}/organizations/peerOrganizations/petani.coedinus.com/peers/peer0.petani.coedinus.com/tls/keystore/* ${PWD}/organizations/peerOrganizations/petani.coedinus.com/peers/peer0.petani.coedinus.com/tls/server.key
  ...
  mkdir -p organizations/peerOrganizations/petani.coedinus.com/users/Admin@petani.coedinuse.com
...
function createRetailer() {
  ...
  cp ${PWD}/organizations/peerOrganizations/retailer.coedinus.com/peers/peer0.retailer.coedinus.com/tls/signcerts/* ${PWD}/organizations/peerOrganizations/retailer.coedinus.com/peers/peer0.retailer.coedinuse.com/tls/server.crt
...
function createOrderer() {
  ...
  mkdir -p ${PWD}/organizations/ordererOrganizations/coedinus.com/msp/tlscacerts
  cp ${PWD}/organizations/ordererOrganizations/coedinus.com/orderers/orderer4.ecoedinus.com/tls/tlscacerts/* ${PWD}/organizations/ordererOrganizations/coedinus.com/msp/tlscacerts/tlsca.coedinus.com-cert.pem
