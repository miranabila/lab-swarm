...
const { buildCCPPetani, buildCCPPengepul, buildWallet, buildCCPDistributor, buildCCPRetailer } = require("./AppUtils");
...
exports.registerUser = async ({ OrgMSP, userId }) => {
    ...
    let ccp = getCCP(org)
    const caClient = buildCAClient(FabricCAServices, ccp, `ca.org${org}.ceodinus.com`);
